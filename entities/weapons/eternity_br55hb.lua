...
SWEP.ViewModel 			= Model("models/vuthakral/halo/weapons/c_hum_br55hb.mdl")
SWEP.WorldModel 		= Model("models/vuthakral/halo/weapons/w_br55hb.mdl")
...
SWEP.AimOffset = {
	ang = Angle(0, 0, 0),
	pos = Vector(-3.56, -6, -1.8)
}

SWEP.Animations = {
	fire = {"fire_0, fire_01, fire_02"},
	reload = "reload_empty",
	draw = "draw"
}
