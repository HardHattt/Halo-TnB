...
SWEP.ViewModel 			= Model("models/vuthakral/halo/weapons/c_hum_ma5c.mdl")
SWEP.WorldModel 		= Model("models/vuthakral/halo/weapons/w_ma5c.mdl")
...
SWEP.FireSound 			= Sound("vuthakral/halo/weapons/ma5c/fire2.wav")
