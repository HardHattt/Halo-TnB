...
function SWEP:DoDrawCrosshair(x, y)
	...
	self.CrossAmount = Lerp(FT * 10, self.CrossAmount, (self.CurrentCone * 350 * (90 / math.Clamp(GetConVar("fov_desired"):GetInt(), 75, 90))) * self:GetZoomLevel())
	self.CrossAmount = math.Round(self.CrossAmount, 3)
...
function SWEP:DrawHUDBackground()
	if self.Scoped then
		...
		surface.SetTexture(surface.GetTextureID("hud/scopes/ce_sniper_scope"))
