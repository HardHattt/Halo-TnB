...
SWEP.ViewModel 			= Model("models/snowysnowtime/eonace/c_fp_ma5k.mdl")
SWEP.WorldModel 		= Model("models/snowysnowtime/eonace/w_ma5k.mdl")
...
SWEP.FireSound 			= Sound("customedition/ma5k_fire3.wav")
