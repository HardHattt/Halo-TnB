...
if CLIENT then
	...
	function CLASS:SetupHands(ply, ent)
		local mdl = ply:Gender() == GENDER_MALE and "models/ishi/halo_rebirth/odst/male/arms/odst_arms_white.mdl" or "models/ishi/halo_rebirth/odst/male/arms/odst_arms_white.mdl"
